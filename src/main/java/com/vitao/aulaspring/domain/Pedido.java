...
@Entity
public class Pedido implements Serializable { // Serializable serve para tranformar os objetos da subclasse Categoria em
                                              // sequencia de Bytes
    ...
    @OneToOne(cascade = CascadeType.ALL, mappedBy = "pedido") // serve para formar um relacionamento de cascata entre
                                                              // pagamento e pedido
    ...
    public String toString() {
        ...
        NumberFormat nf = NumberFormat.getCurrencyInstance(new Locale("pt", "BR")); // formatando numeros usando locale
                                                                                    // BR
